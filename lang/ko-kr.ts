...
export const REPLACEMENTS: Replacement[] = [
  ...
  },
  {
    ...
    changeText: 'Cursor의 외관과 느낌을 구성합니다.',
    searchType: 'exact',
  },
  {
  ...
  },
  {
    ...
    changeText: '활성화하면 코드가 저장되지 않습니다. 비활성화하면 프롬프트와 원격 분석을 사용하여 Cursor를 개선합니다.',
    searchType: 'exact',
  },
  {
  ...
  },
  {
    ...
    changeText: '활성화됨 (모든 코드는 비공개로 유지됨)',
    searchType: 'exact',
  },
  {
    originalText: 'Any questions?',
    changeText: '질문이 있으신가요?',
    searchType: 'exact',
  },
  {
  ...
  // Features
  {
    ...
    changeText: '여러 줄에 걸쳐 변경 사항을 제안할 수 있는 강력한 Copilot 대체 도구입니다. 이전에는 Copilot++라고 불렸습니다.',
    searchType: 'exact',
  },
  {
  ...
  },
  {
    ...
    changeText: '다음 키를 통해 제안의 다음 단어를 수락합니다.',
    searchType: 'partial',
  },
  {
  ...
  },
  {
    ...
    changeText: 'Cursor Tab으로 필요한 모듈을 가져오려면 Tab을 누르세요. 다음의 언어만 지원합니다.',
    searchType: 'partial',
  },
  {
    originalText: 'Auto Import for Python',
    changeText: 'Python용 자동 import',
    searchType: 'exact',
  },
  {
    originalText: 'BETA',
  ...
  },
  {
    ...
    changeText: 'Python에 대한 자동 Import를 활성화합니다. 이것은 베타 기능입니다.',
    searchType: 'exact',
  },
  {
    originalText: 'Chat',
  ...
  },
  {
    ...
    changeText: 'Cursor Agent에게 코드베이스에 대한 질문을 하고, 여러 파일을 동시에 편집하며, 도구를 사용할 수 있습니다.',
    searchType: 'exact',
  },
  {
    originalText: 'Default new chat mode',
    changeText: '기본 새 채팅 모드',
    searchType: 'exact',
  },
  {
    originalText: 'New chats will open on this mode',
    changeText: '새 채팅은 이 모드에서 열립니다.',
    searchType: 'exact',
  },
  {
    originalText: 'Agent',
  ...
  },
  {
    ...
    changeText: '채팅 텍스트 크기',
    searchType: 'exact',
  },
  {
    originalText: 'Adjust the text size of AI chat messages',
    changeText: 'AI 채팅 메시지의 텍스트 크기를 조정합니다.',
    searchType: 'exact',
  },
  {
  ...
  },
  {
    ...
    changeText: '모델이 코드베이스 레이아웃을 이해할 수 있도록 단순화된 디렉토리 트리를 포함합니다.',
    searchType: 'exact',
  },
  {
  ...
  },
  {
    ...
    changeText: '채팅 응답이 완료되면 소리를 재생합니다',
    searchType: 'exact',
  },
  {
  ...
  },
  {
    ...
    changeText: 'LLM과의 채팅 세션에서 이루어진 변경사항을 자동으로 그룹화하여 검토할 수 있게 합니다',
    searchType: 'exact',
  },
  {
  ...
  },
  {
    ...
    changeText: '에이전트/질문 모드의 채팅이 정보를 찾기 위해 웹을 검색할 수 있도록 합니다',
    searchType: 'exact',
  },
  {
  ...
  },
  {
    ...
    changeText: '준비되는 즉시 업데이트를 받습니다. 얼리 액세스 업데이트는 프로덕션 작업에서 불안정할 수 있습니다.',
    searchType: 'exact',
  },
  {
  ...
  },
  {
    ...
    changeText: '채팅과 컴포저 간에 컨텍스트를 작성하고 공유',
    searchType: 'exact',
  },
  {
  ...
  },
  {
    ...
    changeText: '<div>백그라운드 에이전트는 자체 원격 개발 환경에서 병렬로 실행됩니다. 이 기능은 <strong>베타</strong>이며 몇 가지 주의사항이 있습니다:',
    searchType: 'exact',
  },
  {
    ...
    changeText: '<ul><li><strong>개인 정보 보호:</strong> 미리보기 기간 동안 백그라운드 에이전트는 개인 정보 보호 모드를 비활성화한 경우에만 사용할 수 있습니다.</li><li><strong>보안:</strong> 백그라운드 에이전트는 격리된 원격 환경에서 실행됩니다. 이 기능을 구축하는 동안 보안을 우선시했지만, 코드가 아직 감사되지 않았습니다. 우려 사항이 있으면 security@cursor.com으로 이메일을 보내주세요.</li><li><strong>비용:</strong> 미리보기 기간 동안 백그라운드 에이전트는 일반 에이전트와 동일한 비용이 발생합니다(단, 꽤 비용이 많이 들 수 있는 MAX 모델만 지원됩니다).',
    searchType: 'exact',
  },
  {
    originalText: '<div>You can find more details at <span>docs.cursor.com/background-agent</span>.',
    changeText: '<div>자세한 내용은 <span>docs.cursor.com/background-agent</span>를 참조하세요.',
    searchType: 'exact',
  },
  {
    ...
    changeText: '<div class="mt-4 mb-4 relative">미리보기에서 백그라운드 에이전트를 활성화하려면 <span>go to Settings</span> 을 눌러 설정으로 이동 하여 개인 정보 보호 모드를 비활성화하세요.',
    searchType: 'exact',
  },
  {
  ...
  },
  {
    ...
    changeText: '임베딩은 코드베이스 전체 답변을 개선합니다. 임베딩과 메타데이터는 다음 위치에 저장됩니다. ',
    searchType: 'exact',
  },
  {
  ...
  },
  {
    ...
    changeText: '활성화 시 Cursor는 기본적으로 새로 열리는 모든 폴더를 색인합니다. 이 기능을 끄더라도 "인덱스 계산" 버튼을 클릭하여 폴더를 수동으로 색인할 수 있습니다.',
    searchType: 'exact',
  },
  {
    originalText: 'files will not be auto-indexed.',
    changeText: ' 개의 파일은 자동으로 인덱싱되지 않습니다.',
    searchType: 'exact',
  },
  {
